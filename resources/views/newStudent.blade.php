...
<body>
    <div class="w-full max-w-3xl mx-auto mt-10 bg-blue text-right">
        <h1 class="text-center text-4xl">اضافة الطالب</h1>
        <form class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4" action="{{route("students.store")}}"  method="POST">
            @csrf
          <div class="mb-4">
            <label class="block text-gray-700 text-sm font-bold mb-2 " for="name">
              الاسم الكامل
            </label>
            <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="name" name="name" type="text" placeholder="ادخال اسم الطالب كامل">
          </div>
          <div class="mb-6">
            <label class="block text-gray-700 text-sm font-bold mb-2" for="date">
              التاريخ
            </label>
            <input class="shadow appearance-none border border-red-500 rounded w-full py-2 px-3 text-gray-700 mb-3 leading-tight focus:outline-none focus:shadow-outline" id="date" type="date" name="date" placeholder="تاريخ التسجيل">
          </div>
          <div class="mb-6">
            <label class="block text-gray-700 text-sm font-bold mb-2 " for="completions">
                عدد الختمات
            </label>
            <input class="shadow appearance-none border border-red-500 rounded w-full py-2 px-3 text-gray-700 mb-3 leading-tight focus:outline-none focus:shadow-outline" id="completions" name="completions" type="number" min="0">
          </div>
          <div class="mb-6">
            <label class="block text-gray-700 text-sm font-bold mb-2 " for="starting_surah">
                السورة التي بدأ بها الطالب
            </label>
